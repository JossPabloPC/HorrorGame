...
public class Wave_Function_Collapse: I_GridOverride 
{
    ...
    /// </summary>
    public void Load_Primitives(PrimitiveList_Data allRules)
    {
        ...
        for (int i = 0; i < number_of_primitives; i++)
        {
            ...
            m_primitives[allRules.fragmentList[i].id].InitializePrimitive(allRules.fragmentList[i].id, current_sockets);
